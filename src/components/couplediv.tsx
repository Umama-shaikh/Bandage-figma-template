            ...
            <div className="lg:flex lg:gap-24 lg:justify-center text-center lg:text-left  flex flex-col-reverse lg:flex-row mt-16 lg:mt-0">
                ...
                <div className="lg:mt-[178px] lg:ml-14 px-6 lg:px-0">
                    ...
                    <div className="lg:flex lg:gap-2 mt-11 ">
                        <button className="bg-green w-[156px] h-[52px] px-10 py-[15px] rounded-[5px] text-white font-bold text-sm"> BUY NOW</button>
                        <button className="mt-2 lg:mt-0 w-[173px] h-[52px] px-10 py-[15px] rounded-[5px] text-green font-bold text-sm border border-green">READ MORE</button>
                    </div>
                </div>
            </div>
